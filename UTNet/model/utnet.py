...
model = UTNet(in_chan = 3, base_chan = 16, num_classes=23, block_list='1234',num_blocks =[1,2,3,4], num_heads=[2,4,8,16], attn_drop=0.1, proj_drop=0.1)
x = model(torch.randn(1,3,512,768))