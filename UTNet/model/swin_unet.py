...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(512,768), patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=(512,768), patch_size=4, in_chans=3, num_classes=1000,
...
class SwinUnet(nn.Module):
    ...
    def __init__(self, config, img_size=(512,768), num_classes=21843, zero_head=False, vis=False):
